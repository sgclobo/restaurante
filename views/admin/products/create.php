...
<head>
    ...
    <title>Add Product - <?= htmlspecialchars($appName) ?></title>
    ...
    <style>
        ...
        .btn-remove { background: #e74c3c; padding: 5px 10px; font-size: 0.9em; }
        .btn-add-variant { background: #3498db; margin-top: 10px; }
    </style>
</head>
<body>
